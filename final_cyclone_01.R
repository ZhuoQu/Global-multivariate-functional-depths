...
###################################
load("application/neighbours_westpacific.RData")
load("application/clust_westpacific.RData") ## RData should be under the application directory
...
# shift coordinates to recenter worldmap
  ...
  labs(title = paste(loc," Northwest Pacific Cyclone Tracks: Cluster ", clustl, sep = ""),
